    ...
    <section id="aboutUs" className={styles.aboutUs}>
      <div className={styles.aboutUs__container}>
        ...
        <p className={styles.aboutUs_text}>
          ...
          answers to all your financial questions. A convenient portfolio
          manager, an accessible educational segment, a news screener,
          individualized investment and financial plans, advice on managing your
          capital, risk analysis based on a custom AI model, a unique
          sentimental market analysis, the possibility of personal consultations
          with experts - these are all opportunities that offers Sinum Capital
          for its clients.
        </p>
